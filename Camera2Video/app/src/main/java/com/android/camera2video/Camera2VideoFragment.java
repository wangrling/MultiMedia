...
public class Camera2VideoFragment extends Fragment
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mButtonVideo.setImageDrawable(getResources().getDrawable(R.drawable.ic_stop, null));
    ...
    private void stopRecordingVideo() {
        ...
        mButtonVideo.setImageDrawable(getResources().getDrawable(R.drawable.ic_videocam, null));
        // Stop recording
        mMediaRecorder.stop();
